...
class HydrovoltsConnectTabs : public WTabWidget
{
    public:
        HydrovoltsConnectTabs(HydrovoltsConnectModel* pModel, WContainerWidget *parent=0);
        ~HydrovoltsConnectTabs();

    private:
        HydrovoltsConnectChartView* m_pChartView;
        HydrovoltsConnectTableView*  m_pTableView;
