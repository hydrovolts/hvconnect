...
class HydrovoltsConnectProjectsTab : public WTabWidget
{
    public:
        HydrovoltsConnectProjectsTab(HydrovoltsConnectModel* pModel, WContainerWidget *parent=0);
        ~HydrovoltsConnectProjectsTab();

    private:
        HydrovoltsConnectProjects* m_pProjects;
